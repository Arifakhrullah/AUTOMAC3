<?php
    ...
    if(strpos($_SERVER['REQUEST_URI'], basename("signin.php")) !== false){
        echo("<script LANGUAGE='JavaScript'>
            window.alert('Direct access to this page are not permitted!. Please sign in using the Sign in button.');
