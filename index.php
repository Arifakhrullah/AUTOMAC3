    ...
    <div class="container wow fadeInUp" style="margin-left, margin-right: 30%;">
        <div class="row">
            <div class="col-md-12 purpose">
                <h1 id="header__black" class="text-center">OUR PURPOSE <span style="color: #657ab3;">&amp;</span> COMMITMENT</h1>
                <p class="text-center">Our mission is to provide quality products and services through exceptional customer service standards and to be recognized for our strong commitment to serve our customers with integrity, ethical standards, and continuous improvement.
                <br><br>
